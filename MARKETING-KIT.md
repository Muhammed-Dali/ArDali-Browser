...
Link alanlarını paylaşmadan önce doldur:
- `RELEASE_LINK` = GitHub releases linkin
...
## 5) Hızlı Paylaşım Planı (7 Gün)

### TR
1. Gün 1: GitHub README + demo linkini güncelle.
2. Gün 2: 2 toplulukta Genel Lansman metni paylaş.
3. Gün 3: Geri Bildirim Odaklı metni paylaş.
4. Gün 4-5: Gelen yorumlara göre 1 küçük iyileştirme yap.
5. Gün 6: Güncelleme Notu metniyle tekrar paylaş.
6. Gün 7: Sonuçları ölç (indirme sayısı, yıldız, yorum, issue).

### EN
1. Day 1: Update GitHub README + demo link.
2. Day 2: Post the General Launch text in 2 communities.
3. Day 3: Post the Feedback-Focused text.
4. Day 4-5: Ship one small fix from user feedback.
5. Day 6: Re-post with the Release Update text.
6. Day 7: Measure outcomes (downloads, stars, comments, issues).

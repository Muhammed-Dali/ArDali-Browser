...
<p align="center">
  <a href="https://github.com/Muhammed-Dali/ArDali-Browser/releases/tag/v7.1.1"><img src="https://img.shields.io/badge/release-v7.1.1-007ACC.svg?style=flat-square" alt="Release v7.1.1"></a>
...
1. Download the latest `ardali-browser-7.1.1-linux-x86_64.tar.zst` from the [GitHub Releases](https://github.com/Muhammed-Dali/ArDali-Browser/releases) page.
2. Extract the archive and merge the directory tree into `/usr`:

```bash
tar -I zstd -xvf ardali-browser-7.1.1-linux-x86_64.tar.zst
sudo cp -r usr/* /usr/
```

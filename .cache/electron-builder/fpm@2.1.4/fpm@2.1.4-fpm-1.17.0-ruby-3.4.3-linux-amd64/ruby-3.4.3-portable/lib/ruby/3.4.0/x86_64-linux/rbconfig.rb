...
module RbConfig
  RUBY_VERSION.start_with?("3.4.") or
    raise "ruby lib version (3.4.3) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "4"
  CONFIG["TEENY"] = "3"
  CONFIG["PATCHLEVEL"] = "32"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/tmp/ruby-install/ruby-3.4.3-portable")
  ...
  CONFIG["configure_args"] = " '--prefix=/tmp/ruby-install/ruby-3.4.3-portable' '--disable-install-doc' '--disable-rpath' '--disable-dtrace' '--disable-jit-support' '--disable-shared' '--with-static-linked-ext' '--enable-load-relative' '--with-opt-dir=/usr' '--with-libyaml-dir=/usr' '--with-openssl-dir=/usr' '--with-zlib-dir=/usr' '--with-readline-dir=/usr' '--with-baseruby=/usr/bin/ruby' '--without-ext=debug,rbs,syslog,nkf,bigdecimal,racc' 'CFLAGS=-fPIC -O2' 'LDFLAGS=-fPIC -static-libgcc -static-libstdc++' 'CPPFLAGS=-fPIC -O2'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-fPIC -static-libgcc -static-libstdc++ -Wl,--compress-debug-sections=zlib -L/usr/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  CONFIG["POSTLINK"] = ":"
  CONFIG["incflags"] = "-I/usr/include"
  ...
  CONFIG["CXXFLAGS"] = ""
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-fPIC -O2 $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fPIC -static-libgcc -static-libstdc++ -fstack-protector-strong -L/usr/lib -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-fPIC -O2"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "x86_64-pc-linux-gnu"

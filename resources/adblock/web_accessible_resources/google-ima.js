 ...
 * - Modified to avoid jshint warnings as per DeliBlock's config
 ...
 * 
 * Related issue:
 * - https://github.com/DeliBlock/DeliBlock-issues/issues/2158
 * - https://github.com/DeliBlock/uAssets/issues/30134
 * - https://github.com/DeliBlock/uAssets/issues/31018
 * 
**/
...
if (!window.google || !window.google.ima || !window.google.ima.VERSION) {
  ...
  class ImaSdkSettings {
    ...
    // https://github.com/DeliBlock/DeliBlock-issues/issues/2265#issuecomment-1637094149
    getDisableFlashAds() {
    }
    setDisableFlashAds() {
    }

...
assert.match(main, /WEB_DALI_RUNTIME_ASSETS/);
assert.match(main, /web-eq32-reference\.dl\.generated\.js/);
assert.match(main, /web-bass-enhancer\.dl\.generated\.js/);
assert.match(main, /grantRendererPath\(contents, assetPath, \{ recursive: false, write: false \}\)/);

...
const VISUALIZER_NATIVE_BASE = {
  ...
  'visualizerNative.picker.title': 'ArDali Visuals',
...
const OVERRIDES = {
  'tr-TR': {
    ...
    'visualizerNative.picker.title': 'ArDali Görseller',
  ...
  'ar-SA': {
    ...
    'visualizerNative.picker.title': 'مرئيات ArDali',
  ...
  'fr-FR': {
    ...
    'visualizerNative.picker.title': 'Visuels ArDali',
  ...
  'es-ES': {
    ...
    'visualizerNative.picker.title': 'Visuales de ArDali',
  ...
  'hi-IN': {
    ...
    'visualizerNative.picker.title': 'ArDali विज़ुअल्स',

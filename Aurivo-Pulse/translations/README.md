This directory contains instructions that you may follow if you are willing to help translating Aurivo-Pulse, including its GUI as well as its command line specification.
...
You Github account should appear and be listed in the [contributors](https://github.com/marin-m/Aurivo-Pulse/graphs/contributors) if you use an e-mail you also use here.
...
## How to rebuild Aurivo-Pulse while taking in account your translation?
...
1. Download the Aurivo-Pulse source code, either cloning the repository (using for example the `git clone git@github.com:marin-m/Aurivo-Pulse.git` command in your terminal, or directly [downloading the Zipball](https://github.com/marin-m/Aurivo-Pulse/archive/refs/heads/main.zip) from Github and extracting it to your hard disk).
...
4. Follow the [compilation instructions](https://github.com/marin-m/Aurivo-Pulse#compilation), until the `cargo run` command which should launch Aurivo-Pulse while taking in account your translation.
...
* If looking at the source code is not helpful because you don't understand Rust, you may want to ask about it on the [translation Github issue](https://github.com/marin-m/Aurivo-Pulse/issues/23)

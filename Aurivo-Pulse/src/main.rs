...
") */
        ...
        .arg(
            Arg::new("verbose")
                ...
                .help(gettext("-v: Set the log level to DEBUG instead of INFO for Aurivo-Pulse-related messages\n\
-vv: Set the log level to DEBUG for Aurivo-Pulse-related messages and INFO for library-related messages\n\

# ArDali Browser 7.1.2

Released on 13 September 2026.

ArDali Browser 7.1.2 finalizes internal media playback, download manager reliability,
...
- Stabilized Linux desktop integration and panel/taskbar grouping with launcher
  wrapper and explicit `StartupWMClass=ArDaliBrowser` configuration.
...
`ardali-browser-7.1.2-linux-x86_64.tar.zst`.
